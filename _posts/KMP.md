...
![可以画图辅助理解](https://cdn.luogu.com.cn/upload/image_hosting/qpwdmub6.png)

因此我们需要求得一个数组`next`，`next[i] = j`表示在模式串s中，有一个以模式串开头小标为起始下标，以下标i为结尾下标的子串，**这个子串中有一个长度为j的前缀和它的长度为j的后缀完全相等**。
...
![校对过程](https://cdn.luogu.com.cn/upload/image_hosting/ztq5jf9n.png)
...
![校对过程](https://cdn.luogu.com.cn/upload/image_hosting/t08nr4xe.png)
